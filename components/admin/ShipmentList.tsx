    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Manage and track all your shipments</p>
        </div>
      ...
      <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6">
        <div className="flex flex-col lg:flex-row lg:items-center space-y-4 lg:space-y-0 lg:space-x-4">
          ...
          <form onSubmit={handleSearch} className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white border border-gray-300 text-gray-900 placeholder-gray-400 rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent"
              />
            </div>
          </form>
          ...
          <select
            ...
            className="bg-white border border-gray-300 text-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent w-full lg:w-auto"
          >
          ...
          {/* Export Button */}
          <button className="border border-gray-300 text-gray-700 hover:bg-gray-50 px-4 py-2 rounded-lg font-semibold transition-all duration-200 flex items-center space-x-2">
                ...
                {shipments.map((shipment) => (
                  <tr key={shipment._id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(shipment.status.current)}`}>
                        {shipment.status.current.replace('_', ' ').toUpperCase()}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${getPaymentStatusColor(shipment.payment.status)}`}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-3">
                        <Link
                          ...
                          className="text-blue-600 hover:text-blue-700 transition-colors p-1 rounded hover:bg-gray-100"
                          title="View Details"
                        >
                        ...
                        <Link
                          ...
                          className="text-yellow-600 hover:text-yellow-700 transition-colors p-1 rounded hover:bg-gray-100"
                          title="Edit Shipment"
                        >
                        ...
                        <Link
                          ...
                          className="text-green-600 hover:text-green-700 transition-colors p-1 rounded hover:bg-gray-100"
                          title="Track Package"
                        >
                        ...
                        <button
                          ...
                          className="text-red-600 hover:text-red-700 transition-colors p-1 rounded hover:bg-gray-100"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="border border-gray-300 text-gray-700 hover:bg-gray-50 disabled:text-gray-400 px-4 py-2 rounded-lg font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Previous
              </button>
              <button
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white border border-gray-200 rounded-xl max-w-md w-full p-6 shadow-lg">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-900">Delete Shipment</h3>
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="border border-gray-300 text-gray-700 hover:bg-gray-50 px-4 py-2 rounded-lg font-semibold transition-all duration-200 flex-1"
              >
                Cancel
              </button>
              <button
